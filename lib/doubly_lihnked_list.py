...
class DoublyLinkedList:
    ...
    def __find_node(self, pos):
        ...
        # Se, ao contrário, onodo estiver na segunda metade da
        # lista, comepensa fazer um percurso reverso desde
        # o __tail
        else:
            node = self.__tail
    ...
    def insert(self, pos, val):
        ...
        #2° caso: inserção na posição inicial
        elif pos == 0:
        ...
        # 3° caso: inserção na posição final
